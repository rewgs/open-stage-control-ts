...
//     midi = settings.read("midi") ? require("../midi") : false, // NOTE: This is a weird one to import...didn't import below, need to do.
//     oscUDPServer = require("./udp"),
//     oscTCPServer = require("./tcp"),
//     EventEmitter = require("events").EventEmitter,
//     CustomModule = require("../custom-module");
import { ipc } from "../server";
import "../settings";
import * as oscUDPServer from "./udp";
import * as oscTCPServer from "./tcp";
