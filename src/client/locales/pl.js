module.exports = {
    ...
    fragment_mode_explanation: 'Ta sesja zostanie zapisana jako fragment: tylko pierwsze dziecko roota zostanie zapisane.',

    // fullscreen
    fullscreen: 'Tryb pełnoekranowy',
    fullscreen_unnavailable: 'Tryb pełnoekranowy niedostęĻny',
    fullscreen_addtohome: 'Musisz dodać tę stronę do Twojego ekranu domowego by otworzyć ja w trybie pełnoekranowym',
    ...
    remotesave_fail: 'Ten plik nie mógł zostać zapisany na serwerze, użyj eksportu',
    remotesave_success: 'Plik zapisany pomyślnie',
    remotesave_forbidden: 'Nie masz uprawnień do zapisania pliku na serwerze, użyj eksportu',
    ...
    session_unsaved: 'Jeśli zamkniesz tę sesję bez uprzedniego zapisu, wprowadzone zmiany zostaną utracone. Czy chcesz kontynuować?',
    session_oldversion_title: 'Ostrzeżenie',
    session_oldversion: 'Ta sesja została stworzona przy użyciu starszej wersji tego oprogramowania - dokonano automatycznej konwersji. Po zapisaniu, sesja ta prawdopodobnie nie będzie ładować się poprawnie ze starszymi wersjami, zaleca się wykonanie kopii bezpieczeństwa.',
